...
const Cart = ({ datas }) => {
    ...
    return (
        <div onClick={detail} className=" shadow-2xl w-svw lg:w-[350px] border1 lg:ml-10  lg:pl-0 1 rounded-2xl mt-4 lg:mt-0 lg:px-8">
            <div className="card card-compact flex items-center  bg-base-100 text-center  lg:w-[300px] shadow-xl h-[400px] ">
                ...
                <div className="card-body w-full ">
                    ...
                    <div className="font-semibold text-gray-400 lg:flex  ml-4  ">
