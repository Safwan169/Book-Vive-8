                ...
                <div className="hero-content flex-col lg:gap-10 lg:flex-row">
                    ...
                    <div className=' text-left pl-10 pt-10 '>
                        ...
                        <div className='my-14'>
                            ...
                            <p className='flex gap-14 mt-10' ><button className='border-2 border-gray-400 rounded-2xl px-6 text-[18px] btn font-bold '>Read</button><button className='bg-blue-400 btn px-6 rounded-2xl hover:bg-blue-500 font-bold'>Wishlist</button></p>
                        </div>
                    </div>
                </div>
            </div>
